...
export default function Home() {
  return (
    <main className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="pt-20 pb-16 px-4 text-center bg-gradient-to-b from-blue-50 to-white">
        <div className="container mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link 
              href="/workout" 
              className="inline-block py-3 px-8 rounded-full bg-blue-600 text-white font-semibold text-lg transition hover:bg-blue-700"
            >
              Start Workout
            </Link>
            <Link 
              href="/plans" 
              className="inline-block py-3 px-8 rounded-full border-2 border-blue-600 text-blue-600 font-semibold text-lg transition hover:bg-blue-50"
            >
              View Workout Plans
            </Link>
          </div>
